...
public class ControllerCharacteristics : MonoBehaviour
{
    ...
    private void ControllerSpawn()
    {
        if (isRight)
        {
            ...
            if (Rdevices.Count > 0)
            {
                ...
                rHandAnimator = spawnedController.GetComponent<Animator>();
            }
        ...
        else
        {
            ...
            if (Ldevices.Count > 0)
            {
                ...
                lHandAnimator = spawnedController.GetComponent<Animator>();
            }
    ...
    private void ControllerInput()
    {
        ...
        if (rightDevice.TryGetFeatureValue(CommonUsages.primary2DAxisClick, out bool Rsecondary2DAxisValue) && Rsecondary2DAxisValue)//LEFT THUMBSTICK PRESS
        {
        ...
        if (rightDevice.TryGetFeatureValue(CommonUsages.secondaryTouch, out bool rPrimaryTouch) && rPrimaryTouch)
        {
        ...
        if (leftDevice.TryGetFeatureValue(CommonUsages.primary2DAxisClick, out bool Lsecondary2DAxisValue) && Lsecondary2DAxisValue)//LEFT THUMBSTICK PRESS
        {
        ...
        if (leftDevice.TryGetFeatureValue(CommonUsages.secondaryTouch, out bool LprimaryTouch) && LprimaryTouch)
        {
